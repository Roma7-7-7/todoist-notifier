...
func (c *Client) GetTasksLimit200(ctx context.Context, isCompleted bool) ([]Task, error) {
	req, err := http.NewRequestWithContext(ctx, http.MethodGet, baseURL+"/tasks?limit=200", nil)
	if err != nil {
